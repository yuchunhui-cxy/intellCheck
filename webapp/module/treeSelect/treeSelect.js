        ...
        var init = {
            ...
            setIndex: function (data, parentDom, isRoot) {
                ...
                if (isRoot) {
                    ...
                    tree.addClass('layui-show');
                    tree.css('margin-left','15px');
                }
                for (var i = 0; i < d.length; i++) {
                    var obj = d[i];
                    var iSpread = '<i class="layui-icon layui-icon-triangle-d"></i>';
                    // 没有子节点，不需要图标
            ...
            spreadToggle: function () {
                init.event('click', '.layui-treeselect .layui-tree li>i.layui-icon', function () {
                    ...
                    if (!ul.hasClass('layui-show')) {
                        ul.removeClass('layui-hide').addClass('layui-show');
                        $(this).addClass(down).removeClass(right);
                    } else {
                        ul.removeClass('layui-show').addClass('layui-hide');
